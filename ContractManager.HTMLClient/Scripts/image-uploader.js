function createImageUploader(element, contentItem, previewStyle) {
        ...
        $file_browse_button.bind('change', function handleFileSelect(evt) {
            ...
            if (files.length == 1) {
                ...
                reader.onload = function (e) {
                    previewImageAndSetContentItem(e.target.result, $preview, contentItem, files[0].name);
    ...
    function previewImageAndSetContentItem(fullBinaryString, $preview, contentItem, filename) {
        $preview.empty();
        ...
        if ((fullBinaryString == null) || (fullBinaryString.length == 0)) {
            ...
            var noteContentItem = contentItem.screen.findContentItem("FileName");
            noteContentItem.stringValue = filename;
